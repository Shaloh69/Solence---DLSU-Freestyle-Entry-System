  ...
  return (
    <section className="flex flex-col items-center justify-center w-full max-w-5xl mx-auto px-6">
      ...
      <div className="w-full py-12 md:py-16 text-center">
        <h1 className={`${title({ color: "brand" })} mb-4`}>About Solence</h1>
        <p
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-gray-900/30 backdrop-blur-md border border-gray-800/50 rounded-xl p-6 flex items-start">
            <div className="mr-4 mt-1">
              <div className="h-10 w-10 rounded-full bg-brand-teal/10 border border-brand-teal/30 flex items-center justify-center">
      ...
      <div className="w-full mb-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {teamMembers.map((member, index) => (
            ...
            >
              <div className="h-24 w-24 rounded-full bg-brand-teal/10 border border-brand-teal/30 flex items-center justify-center mb-4">
      ...
      {/* Advisor */}
      <div className="w-full mb-16">
        <div className="bg-gradient-to-r from-brand-navy-light/60 to-brand-navy/60 backdrop-blur-md rounded-xl p-6 md:p-8 border border-brand-navy-border">
          <div className="flex flex-col md:flex-row items-center gap-6">
            <div className="h-24 w-24 rounded-full bg-brand-teal/10 border border-brand-teal/30 flex items-center justify-center">
              <GraduationCap className="h-12 w-12 text-brand-teal" />
            </div>
            <div>
      ...
      <div className="w-full py-6 mb-12">
        <div className="flex flex-col items-center text-center">
          ...
          <Link
            href="/simulator"
            className="bg-brand-teal-dark hover:bg-brand-teal transition-all px-8 py-3 rounded-full text-white font-medium flex items-center gap-2"
          >
            Get Started
            <ArrowRight size={18} />
          </Link>
